module CPU_TOP (clk,
 ...
 sky130_fd_sc_hd__nor4_2 _2540_ (.A(_0501_),
    ...
    .D(_0504_),
    .Y(_0505_));
 sky130_fd_sc_hd__or4_1 _2541_ (.A(\cpu_inst.decoder_inst.current_pc[10] ),
 ...
 sky130_fd_sc_hd__buf_2 _2549_ (.A(_0513_),
    .X(_0514_));
 sky130_fd_sc_hd__or4_1 _2550_ (.A(_0501_),
    .B(_0502_),
    .C(_0503_),
    .D(_0504_),
    .X(_0515_));
 sky130_fd_sc_hd__buf_2 _2551_ (.A(_0515_),
    .X(_0516_));
 sky130_fd_sc_hd__or2_1 _2552_ (.A(_0506_),
    .B(_0507_),
    .X(_0517_));
 ...
 sky130_fd_sc_hd__buf_2 _2558_ (.A(_0522_),
    .X(_0523_));
 sky130_fd_sc_hd__or4_4 _2559_ (.A(_0516_),
    .B(_0518_),
    .C(_0520_),
    .D(_0523_),
    .X(_0524_));
 ...
 sky130_fd_sc_hd__nand2_1 _2561_ (.A(\cpu_inst.decoder_inst.current_pc[6] ),
    .B(_0525_),
    .Y(_0526_));
 sky130_fd_sc_hd__or4_4 _2562_ (.A(_0516_),
    .B(_0518_),
    .C(_0523_),
    .D(_0526_),
    .X(_0527_));
 ...
 sky130_fd_sc_hd__or2_1 _2569_ (.A(_0510_),
    .B(_0533_),
    .X(_0534_));
 sky130_fd_sc_hd__or3_1 _2570_ (.A(_0516_),
    .B(_0518_),
    .C(_0534_),
    .X(_0535_));
 sky130_fd_sc_hd__buf_2 _2571_ (.A(_0535_),
    .X(_0536_));
 sky130_fd_sc_hd__clkbuf_2 _2572_ (.A(_0516_),
    .X(_0537_));
 sky130_fd_sc_hd__clkbuf_2 _2573_ (.A(_0518_),
    .X(_0538_));
 sky130_fd_sc_hd__nor3_1 _2574_ (.A(_0537_),
    .B(_0538_),
    .C(_0523_),
    .Y(_0539_));
 ...
 sky130_fd_sc_hd__and4b_2 _2581_ (.A_N(_0528_),
    ...
    .D(_0545_),
    .X(_0546_));
 sky130_fd_sc_hd__or3_1 _2582_ (.A(_0515_),
    .B(_0517_),
    .C(_0544_),
    .X(_0547_));
 sky130_fd_sc_hd__buf_4 _2583_ (.A(_0547_),
    .X(_0548_));
 ...
 sky130_fd_sc_hd__nand3b_2 _2586_ (.A_N(\cpu_inst.decoder_inst.current_pc[1] ),
    ...
    .C(_0521_),
    .Y(_0551_));
 sky130_fd_sc_hd__or4_1 _2587_ (.A(_0516_),
    .B(_0518_),
    .C(_0551_),
    .D(_0511_),
    .X(_0552_));
 sky130_fd_sc_hd__and3_1 _2588_ (.A(_0548_),
    .B(_0550_),
    .C(_0552_),
    .X(_0553_));
 sky130_fd_sc_hd__clkbuf_2 _2589_ (.A(_0533_),
    .X(_0554_));
 sky130_fd_sc_hd__or4_4 _2590_ (.A(_0516_),
    .B(_0518_),
    .C(_0554_),
    .D(_0523_),
    .X(_0555_));
 ...
 sky130_fd_sc_hd__or4_2 _2593_ (.A(_0537_),
    ...
    .D(_0526_),
    .X(_0558_));
 sky130_fd_sc_hd__and4_1 _2594_ (.A(_0555_),
    .B(_0556_),
    .C(_0557_),
    .D(_0558_),
    .X(_0559_));
 ...
 sky130_fd_sc_hd__or3_2 _2598_ (.A(\cpu_inst.decoder_inst.current_pc[5] ),
    ...
    .C(\cpu_inst.decoder_inst.current_pc[7] ),
    .X(_0563_));
 sky130_fd_sc_hd__or3_4 _2599_ (.A(_0516_),
    .B(_0518_),
    .C(_0523_),
    .X(_0564_));
 ...
 sky130_fd_sc_hd__o2111ai_4 _2601_ (.A1(_0563_),
    ...
    .D1(_0565_),
    .Y(_0566_));
 sky130_fd_sc_hd__or4_1 _2602_ (.A(_0516_),
    .B(_0518_),
    .C(_0554_),
    .D(_0549_),
    .X(_0567_));
 sky130_fd_sc_hd__or4_1 _2603_ (.A(_0515_),
    .B(_0517_),
    .C(_0554_),
    .D(_0551_),
    .X(_0568_));
 sky130_fd_sc_hd__clkbuf_4 _2604_ (.A(_0568_),
    .X(_0569_));
 ...
 sky130_fd_sc_hd__or3_4 _2608_ (.A(_0537_),
    ...
    .C(_0572_),
    .X(_0573_));
 sky130_fd_sc_hd__nand2_1 _2609_ (.A(_0573_),
    .B(_0567_),
    .Y(_0574_));
 ...
 sky130_fd_sc_hd__or3_2 _2615_ (.A(_0537_),
    ...
    .C(_0549_),
    .X(_0580_));
 sky130_fd_sc_hd__or4_1 _2616_ (.A(_0537_),
    .B(_0538_),
    .C(_0554_),
    .D(_0551_),
    .X(_0581_));
 sky130_fd_sc_hd__o21ai_1 _2617_ (.A1(_0520_),
    .A2(_0580_),
    .B1(_0581_),
    .Y(_0582_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _2619_ (.A(_0583_),
    .X(_0584_));
 sky130_fd_sc_hd__mux2_1 _2620_ (.A0(\cpu_inst.regfile_inst.registers[10][0] ),
    .A1(\cpu_inst.regfile_inst.registers[11][0] ),
    .S(_0560_),
    .X(_0585_));
 sky130_fd_sc_hd__or3_1 _2621_ (.A(_0574_),
    .B(_0579_),
    .C(_0582_),
    .X(_0586_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _2628_ (.A(_0592_),
    .X(_0593_));
 sky130_fd_sc_hd__o311a_1 _2629_ (.A1(_0529_),
    .A2(_0549_),
    .A3(_0531_),
    .B1(_0548_),
    .C1(_0552_),
 ...
 sky130_fd_sc_hd__mux2_1 _2631_ (.A0(\cpu_inst.regfile_inst.registers[1][0] ),
    ...
    .S(_0595_),
    .X(_0596_));
 sky130_fd_sc_hd__mux2_1 _2632_ (.A0(\cpu_inst.regfile_inst.registers[2][0] ),
    .A1(_0596_),
    .S(_0584_),
    .X(_0597_));
 sky130_fd_sc_hd__clkbuf_4 _2633_ (.A(_0586_),
    .X(_0598_));
 ...
 sky130_fd_sc_hd__or3_2 _2637_ (.A(_0528_),
    ...
    .C(_0588_),
    .X(_0602_));
 sky130_fd_sc_hd__buf_2 _2638_ (.A(_0602_),
    .X(_0603_));
 ...
 sky130_fd_sc_hd__nand2_4 _2641_ (.A(_0569_),
    .B(_0524_),
    .Y(_0606_));
 sky130_fd_sc_hd__a21o_1 _2642_ (.A1(_0590_),
    .A2(_0605_),
    .B1(_0606_),
    .X(_0607_));
 ...
 sky130_fd_sc_hd__a22oi_4 _2654_ (.A1(_0546_),
    ...
    .B2(_0618_),
    .Y(_0619_));
 sky130_fd_sc_hd__clkbuf_4 _2655_ (.A(_0595_),
    .X(_0620_));
 ...
 sky130_fd_sc_hd__a21o_1 _2667_ (.A1(_0613_),
    ...
    .B1(_0631_),
    .X(_0632_));
 sky130_fd_sc_hd__a21o_1 _2668_ (.A1(_0626_),
    .A2(_0632_),
    .B1(_0606_),
    .X(_0633_));
 ...
 sky130_fd_sc_hd__nor2_2 _2671_ (.A(_0635_),
    .B(_0616_),
    .Y(_0636_));
 sky130_fd_sc_hd__buf_4 _2672_ (.A(_0636_),
    .X(_0637_));
 ...
 sky130_fd_sc_hd__and2_1 _2678_ (.A(_0642_),
    .B(_0546_),
    .X(_0643_));
 sky130_fd_sc_hd__a31oi_4 _2679_ (.A1(_0633_),
    .A2(_0637_),
    .A3(_0641_),
    .B1(_0643_),
    .Y(_0644_));
 ...
 sky130_fd_sc_hd__or2_1 _2776_ (.A(\cpu_inst.regfile_inst.registers[24][0] ),
    .B(_0640_),
    .X(_0741_));
 sky130_fd_sc_hd__a32o_1 _2777_ (.A1(_0636_),
    .A2(_0607_),
    .A3(_0741_),
    .B1(_0732_),
    .B2(_0635_),
 ...
 sky130_fd_sc_hd__mux2_1 _2795_ (.A0(\cpu_inst.regfile_inst.registers[10][2] ),
    ...
    .S(_0560_),
    .X(_0760_));
 sky130_fd_sc_hd__mux2_1 _2796_ (.A0(\cpu_inst.regfile_inst.registers[8][2] ),
    .A1(_0760_),
    .S(_0598_),
    .X(_0761_));
 sky130_fd_sc_hd__a21o_1 _2797_ (.A1(\cpu_inst.regfile_inst.registers[15][2] ),
    ...
    .B1(_0571_),
    .X(_0762_));
 sky130_fd_sc_hd__a21oi_1 _2798_ (.A1(_0720_),
    .A2(_0761_),
    .B1(_0762_),
    .Y(_0763_));
 ...
 sky130_fd_sc_hd__a31o_2 _2805_ (.A1(_0617_),
    ...
    .B1(_0769_),
    .X(_0770_));
 sky130_fd_sc_hd__or4_1 _2806_ (.A(_0740_),
    .B(_0742_),
    .C(_0756_),
    .D(_0770_),
    .X(_0771_));
 sky130_fd_sc_hd__mux2_1 _2807_ (.A0(\cpu_inst.regfile_inst.registers[11][4] ),
    .A1(\cpu_inst.regfile_inst.registers[10][4] ),
    .S(_0595_),
    .X(_0772_));
 sky130_fd_sc_hd__mux2_1 _2808_ (.A0(\cpu_inst.regfile_inst.registers[8][4] ),
    .A1(_0772_),
    .S(_0598_),
    .X(_0773_));
 ...
 sky130_fd_sc_hd__or2_1 _2816_ (.A(\cpu_inst.regfile_inst.registers[24][4] ),
    .B(_0640_),
    .X(_0781_));
 sky130_fd_sc_hd__a31o_1 _2817_ (.A1(_0636_),
    .A2(_0780_),
    .A3(_0781_),
    .B1(_0639_),
    .X(_0782_));
 ...
 sky130_fd_sc_hd__or2_1 _2820_ (.A(_0701_),
    .B(_0784_),
    .X(_0785_));
 sky130_fd_sc_hd__mux2_1 _2821_ (.A0(\cpu_inst.regfile_inst.registers[10][7] ),
 ...
 sky130_fd_sc_hd__a31o_1 _2829_ (.A1(_0785_),
    ...
    .B1(_0611_),
    .X(_0794_));
 sky130_fd_sc_hd__a31o_1 _2830_ (.A1(_0636_),
    .A2(_0783_),
    .A3(_0794_),
    .B1(_0639_),
    .X(_0795_));
 ...
 sky130_fd_sc_hd__o221a_1 _2840_ (.A1(\cpu_inst.regfile_inst.registers[24][5] ),
    ...
    .C1(_0637_),
    .X(_0805_));
 sky130_fd_sc_hd__mux2_1 _2841_ (.A0(\cpu_inst.regfile_inst.registers[11][6] ),
 ...
 sky130_fd_sc_hd__mux2_1 _2842_ (.A0(\cpu_inst.regfile_inst.registers[8][6] ),
    ...
    .S(_0598_),
    .X(_0807_));
 sky130_fd_sc_hd__mux2_1 _2843_ (.A0(\cpu_inst.regfile_inst.registers[15][6] ),
    .A1(_0807_),
    .S(_0720_),
    .X(_0808_));
 ...
 sky130_fd_sc_hd__o221a_1 _2846_ (.A1(\cpu_inst.regfile_inst.registers[1][6] ),
    ...
    .C1(_0561_),
    .X(_0811_));
 sky130_fd_sc_hd__or3_1 _2847_ (.A(_0613_),
    .B(_0810_),
    .C(_0811_),
    .X(_0812_));
 sky130_fd_sc_hd__o221a_1 _2848_ (.A1(_0714_),
    .A2(_0808_),
    .B1(_0809_),
    .B2(_0701_),
    .C1(_0812_),
 ...
 sky130_fd_sc_hd__o221ai_4 _2849_ (.A1(\cpu_inst.regfile_inst.registers[24][6] ),
    ...
    .C1(_0699_),
    .Y(_0814_));
 sky130_fd_sc_hd__or4b_1 _2850_ (.A(_0782_),
    .B(_0795_),
    .C(_0805_),
    .D_N(_0814_),
    .X(_0815_));
 sky130_fd_sc_hd__nor2_1 _2851_ (.A(_0771_),
    .B(_0815_),
    .Y(_0816_));
 ...
 sky130_fd_sc_hd__or2_1 _2966_ (.A(_0639_),
    .B(_0805_),
    .X(_0931_));
 sky130_fd_sc_hd__o21a_1 _2967_ (.A1(_0771_),
    .A2(_0782_),
    .B1(_0548_),
    .X(_0932_));
 sky130_fd_sc_hd__mux2_1 _2968_ (.A0(_0930_),
    ...
    .S(_0932_),
    .X(_0933_));
 sky130_fd_sc_hd__or2b_1 _2969_ (.A(_0929_),
    .B_N(_0933_),
    .X(_0934_));
 ...
 sky130_fd_sc_hd__nand2_1 _2984_ (.A(_0946_),
    .B(_0948_),
    .Y(_0949_));
 sky130_fd_sc_hd__a211o_1 _2985_ (.A1(_0920_),
    .A2(_0934_),
    .B1(_0936_),
    .C1(_0949_),
    .X(_0950_));
 ...
 sky130_fd_sc_hd__inv_2 _2998_ (.A(_0962_),
    .Y(_0963_));
 sky130_fd_sc_hd__a21oi_1 _2999_ (.A1(_0816_),
    .A2(_0963_),
    .B1(_0514_),
    .Y(_0964_));
 sky130_fd_sc_hd__a31o_1 _3000_ (.A1(_0859_),
    ...
    .B1(_0610_),
    .X(_0965_));
 sky130_fd_sc_hd__xnor2_1 _3001_ (.A(_0964_),
    .B(_0965_),
    .Y(_0966_));
 ...
 sky130_fd_sc_hd__o211a_1 _3008_ (.A1(\cpu_inst.regfile_inst.registers[25][9] ),
    ...
    .C1(_0972_),
    .X(_0973_));
 sky130_fd_sc_hd__nor2_1 _3009_ (.A(_0966_),
    .B(_0973_),
    .Y(_0974_));
 ...
 sky130_fd_sc_hd__nand2_1 _3023_ (.A(_0986_),
    .B(_0987_),
    .Y(_0988_));
 sky130_fd_sc_hd__or2_1 _3024_ (.A(_0976_),
    .B(_0988_),
    .X(_0989_));
 ...
 sky130_fd_sc_hd__inv_2 _3026_ (.A(_0990_),
    .Y(_0991_));
 sky130_fd_sc_hd__a31o_1 _3027_ (.A1(_0816_),
    .A2(_0840_),
    .A3(_0991_),
    .B1(_0514_),
    .X(_0992_));
 sky130_fd_sc_hd__nor2_1 _3028_ (.A(_0639_),
    .B(_0739_),
    .Y(_0993_));
 sky130_fd_sc_hd__xnor2_1 _3029_ (.A(_0992_),
    .B(_0993_),
    .Y(_0994_));
 ...
 sky130_fd_sc_hd__o211a_1 _3036_ (.A1(\cpu_inst.regfile_inst.registers[25][11] ),
    ...
    .C1(_1000_),
    .X(_1001_));
 sky130_fd_sc_hd__nor2_1 _3037_ (.A(_0994_),
    .B(_1001_),
    .Y(_1002_));
 ...
 sky130_fd_sc_hd__nand2_1 _3051_ (.A(_1014_),
    .B(_1015_),
    .Y(_1016_));
 sky130_fd_sc_hd__or2_1 _3052_ (.A(_1004_),
    .B(_1016_),
    .X(_1017_));
 ...
 sky130_fd_sc_hd__nand2_1 _3060_ (.A(_1024_),
    .B(_0878_),
    .Y(_1025_));
 sky130_fd_sc_hd__a21o_1 _3061_ (.A1(_1019_),
    .A2(_1021_),
    .B1(_1025_),
    .X(_1026_));
 ...
 sky130_fd_sc_hd__nand3_1 _3083_ (.A(_0878_),
    ...
    .C(_1047_),
    .Y(_1048_));
 sky130_fd_sc_hd__or2_1 _3084_ (.A(_1026_),
    .B(_1047_),
    .X(_1049_));
 ...
 sky130_fd_sc_hd__a21o_1 _3112_ (.A1(_1057_),
    ...
    .B1(_0680_),
    .X(_1077_));
 sky130_fd_sc_hd__or2_1 _3113_ (.A(_0740_),
    .B(_1077_),
    .X(_1078_));
 ...
 sky130_fd_sc_hd__buf_4 _3123_ (.A(_1087_),
    .X(_1088_));
 sky130_fd_sc_hd__o22a_1 _3124_ (.A1(_0573_),
    .A2(_1084_),
    .B1(_1086_),
    .B2(_1088_),
    .X(_1089_));
 ...
 sky130_fd_sc_hd__o31a_1 _3130_ (.A1(_0911_),
    ...
    .B1(_1094_),
    .X(_1095_));
 sky130_fd_sc_hd__a21oi_1 _3131_ (.A1(_0950_),
    .A2(_0960_),
    .B1(_1018_),
    .Y(_1096_));
 ...
 sky130_fd_sc_hd__xnor2_1 _3210_ (.A(_1096_),
    .B(_0988_),
    .Y(_1175_));
 sky130_fd_sc_hd__buf_2 _3211_ (.A(_0740_),
    .X(_1176_));
 ...
 sky130_fd_sc_hd__nand3_1 _3220_ (.A(_1019_),
    ...
    .C(_1025_),
    .Y(_1185_));
 sky130_fd_sc_hd__or3_1 _3221_ (.A(_0740_),
    .B(_0912_),
    .C(_1104_),
    .X(_1186_));
 ...
 sky130_fd_sc_hd__buf_2 _3243_ (.A(_0756_),
    .X(_1208_));
 sky130_fd_sc_hd__nand2_1 _3244_ (.A(_0740_),
    .B(_1082_),
    .Y(_1209_));
 ...
 sky130_fd_sc_hd__or2_1 _3357_ (.A(\cpu_inst.regfile_inst.registers[24][2] ),
    .B(_0640_),
    .X(_1307_));
 sky130_fd_sc_hd__a31o_1 _3358_ (.A1(_0637_),
    .A2(_0768_),
    .A3(_1307_),
    .B1(_0769_),
    .X(_1308_));
 ...
 sky130_fd_sc_hd__o2111a_1 _3366_ (.A1(\cpu_inst.regfile_inst.registers[25][0] ),
    ...
    .D1(_1315_),
    .X(_1316_));
 sky130_fd_sc_hd__clkbuf_4 _3367_ (.A(_0742_),
    .X(_1317_));
 ...
 sky130_fd_sc_hd__or4_1 _3379_ (.A(_0684_),
    ...
    .D(_1296_),
    .X(_1329_));
 sky130_fd_sc_hd__a311o_1 _3380_ (.A1(_0594_),
    .A2(_1326_),
    .A3(_1327_),
    .B1(_1328_),
    .C1(_1329_),
 ...
 sky130_fd_sc_hd__clkbuf_1 _3399_ (.A(_1341_),
    .X(_0012_));
 sky130_fd_sc_hd__mux2_1 _3400_ (.A0(_1075_),
    .A1(\cpu_inst.regfile_inst.registers[6][13] ),
    .S(_1339_),
    .X(_1342_));
 ...
 sky130_fd_sc_hd__or2_1 _3406_ (.A(_1135_),
    .B(_1248_),
    .X(_1345_));
 sky130_fd_sc_hd__a2111o_1 _3407_ (.A1(_1019_),
    .A2(_1021_),
    .B1(_1025_),
    .C1(_1047_),
    .D1(_1345_),
 ...
 sky130_fd_sc_hd__or2_1 _3593_ (.A(_1445_),
    .B(_1484_),
    .X(_1528_));
 sky130_fd_sc_hd__a2111o_1 _3594_ (.A1(_1346_),
    .A2(_1347_),
    .B1(_1375_),
    .C1(_1527_),
    .D1(_1528_),
 ...
 sky130_fd_sc_hd__clkbuf_1 _3642_ (.A(_1575_),
    .X(_0021_));
 sky130_fd_sc_hd__a211o_1 _3643_ (.A1(_1529_),
    .A2(_1531_),
    .B1(_1570_),
    .C1(_1526_),
    .X(_1576_));
 ...
 sky130_fd_sc_hd__xor2_1 _3667_ (.A(_1584_),
    .B(_1599_),
    .X(_1600_));
 sky130_fd_sc_hd__a21o_1 _3668_ (.A1(_1576_),
    .A2(_1577_),
    .B1(_1600_),
    .X(_1601_));
 ...
 sky130_fd_sc_hd__and3_1 _3702_ (.A(_1611_),
    ...
    .C(_1633_),
    .X(_1634_));
 sky130_fd_sc_hd__a21oi_1 _3703_ (.A1(_1611_),
    .A2(_1601_),
    .B1(_1633_),
    .Y(_1635_));
 sky130_fd_sc_hd__nor2_1 _3704_ (.A(_1634_),
    .B(_1635_),
    .Y(_1636_));
 ...
 sky130_fd_sc_hd__o31a_1 _3711_ (.A1(_1208_),
    ...
    .B1(_0683_),
    .X(_1643_));
 sky130_fd_sc_hd__a21o_1 _3712_ (.A1(_1224_),
    .A2(_1636_),
    .B1(_1643_),
    .X(_1644_));
 ...
 sky130_fd_sc_hd__nand2_1 _3793_ (.A(_1680_),
    .B(_1721_),
    .Y(_1723_));
 sky130_fd_sc_hd__a211o_1 _3794_ (.A1(_1648_),
    .A2(_1653_),
    .B1(_1681_),
    .C1(_1721_),
    .X(_1724_));
 ...
 sky130_fd_sc_hd__o211a_1 _3874_ (.A1(\cpu_inst.regfile_inst.registers[25][28] ),
    ...
    .C1(_1800_),
    .X(_1801_));
 sky130_fd_sc_hd__and3_1 _3875_ (.A(_0637_),
    .B(_1778_),
    .C(_1779_),
    .X(_1802_));
 ...
 sky130_fd_sc_hd__o21bai_2 _3899_ (.A1(_1724_),
    ...
    .B1_N(_1825_),
    .Y(_1826_));
 sky130_fd_sc_hd__xnor2_1 _3900_ (.A(_1819_),
    .B(_1826_),
    .Y(_1827_));
 ...
 sky130_fd_sc_hd__mux2_1 _3965_ (.A0(\cpu_inst.regfile_inst.registers[24][30] ),
    ...
    .S(_0640_),
    .X(_1890_));
 sky130_fd_sc_hd__a21o_1 _3966_ (.A1(_0637_),
    .A2(_1890_),
    .B1(_0639_),
    .X(_1891_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _4122_ (.A(_2000_),
    .X(_0076_));
 sky130_fd_sc_hd__mux2_1 _4123_ (.A0(_1075_),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4325_ (.A(_2107_),
    .X(_0172_));
 sky130_fd_sc_hd__mux2_1 _4326_ (.A0(_1075_),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4458_ (.A(_2176_),
    .X(_0236_));
 sky130_fd_sc_hd__mux2_1 _4459_ (.A0(_1075_),
 ...
 sky130_fd_sc_hd__or4b_1 _4643_ (.A(_1183_),
    ...
    .D_N(_2275_),
    .X(_2276_));
 sky130_fd_sc_hd__or3_1 _4644_ (.A(_1075_),
    .B(_1100_),
    .C(_2276_),
    .X(_2277_));
 sky130_fd_sc_hd__or4_1 _4645_ (.A(_1164_),
    .B(_1192_),
    .C(_2273_),
    .D(_2277_),
    .X(_2278_));
 sky130_fd_sc_hd__or3_1 _4646_ (.A(_1456_),
    .B(_2272_),
    .C(_2278_),
    .X(_2279_));
 sky130_fd_sc_hd__or4_1 _4647_ (.A(_1260_),
    .B(_1534_),
    .C(_1574_),
    .D(_2279_),
    .X(_2280_));
 sky130_fd_sc_hd__or4_1 _4648_ (.A(_1493_),
    .B(_1608_),
    .C(_1726_),
    .D(_2280_),
    .X(_2281_));
 sky130_fd_sc_hd__or4_1 _4649_ (.A(_1644_),
    .B(_1692_),
    .C(_1760_),
    .D(_1833_),
    .X(_2282_));
 sky130_fd_sc_hd__or3_1 _4650_ (.A(_1792_),
    .B(_1867_),
    .C(_2282_),
    .X(_2283_));
 ...
 sky130_fd_sc_hd__o21a_1 _4660_ (.A1(_0521_),
    ...
    .B1(_2291_),
    .X(_0323_));
 sky130_fd_sc_hd__and3_1 _4661_ (.A(_0527_),
    .B(_1988_),
    .C(_2284_),
    .X(_2292_));
 sky130_fd_sc_hd__clkbuf_2 _4662_ (.A(_2292_),
    .X(_2293_));
 ...
 sky130_fd_sc_hd__and2_1 _4682_ (.A(\cpu_inst.decoder_inst.current_pc[8] ),
    .B(_2303_),
    .X(_2308_));
 sky130_fd_sc_hd__xor2_1 _4683_ (.A(\cpu_inst.decoder_inst.current_pc[9] ),
    .B(_2308_),
    .X(_2309_));
 ...
 sky130_fd_sc_hd__a21oi_1 _4686_ (.A1(_1295_),
    ...
    .Y(_2311_));
 sky130_fd_sc_hd__a21oi_1 _4687_ (.A1(\cpu_inst.decoder_inst.current_pc[9] ),
    .A2(_2308_),
    .B1(\cpu_inst.decoder_inst.current_pc[10] ),
    .Y(_2312_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _4921_ (.A(_2447_),
    .X(_0428_));
 sky130_fd_sc_hd__mux2_1 _4922_ (.A0(_1075_),
    .A1(\cpu_inst.regfile_inst.registers[8][13] ),
    .S(_2432_),
    .X(_2448_));
 ...
 sky130_fd_sc_hd__dfxtp_1 _5080_ (.CLK(clk),
    .D(_0000_),
    .Q(\cpu_inst.regfile_inst.registers[6][0] ));
 sky130_fd_sc_hd__dfxtp_1 _5081_ (.CLK(clk),
    .D(_0001_),
    .Q(\cpu_inst.regfile_inst.registers[6][1] ));
 sky130_fd_sc_hd__dfxtp_1 _5082_ (.CLK(clk),
    .D(_0002_),
    .Q(\cpu_inst.regfile_inst.registers[6][2] ));
 sky130_fd_sc_hd__dfxtp_1 _5083_ (.CLK(clk),
    .D(_0003_),
    .Q(\cpu_inst.regfile_inst.registers[6][3] ));
 sky130_fd_sc_hd__dfxtp_1 _5084_ (.CLK(clk),
    .D(_0004_),
    .Q(\cpu_inst.regfile_inst.registers[6][4] ));
 sky130_fd_sc_hd__dfxtp_1 _5085_ (.CLK(clk),
    .D(_0005_),
    .Q(\cpu_inst.regfile_inst.registers[6][5] ));
 sky130_fd_sc_hd__dfxtp_1 _5086_ (.CLK(clk),
    .D(_0006_),
    .Q(\cpu_inst.regfile_inst.registers[6][6] ));
 sky130_fd_sc_hd__dfxtp_1 _5087_ (.CLK(clk),
    .D(_0007_),
    .Q(\cpu_inst.regfile_inst.registers[6][7] ));
 sky130_fd_sc_hd__dfxtp_1 _5088_ (.CLK(clk),
    .D(_0008_),
    .Q(\cpu_inst.regfile_inst.registers[6][8] ));
 sky130_fd_sc_hd__dfxtp_1 _5089_ (.CLK(clk),
    .D(_0009_),
    .Q(\cpu_inst.regfile_inst.registers[6][9] ));
 sky130_fd_sc_hd__dfxtp_1 _5090_ (.CLK(clk),
    .D(_0010_),
    .Q(\cpu_inst.regfile_inst.registers[6][10] ));
 sky130_fd_sc_hd__dfxtp_1 _5091_ (.CLK(clk),
    .D(_0011_),
    .Q(\cpu_inst.regfile_inst.registers[6][11] ));
 sky130_fd_sc_hd__dfxtp_1 _5092_ (.CLK(clk),
    .D(_0012_),
    .Q(\cpu_inst.regfile_inst.registers[6][12] ));
 sky130_fd_sc_hd__dfxtp_1 _5093_ (.CLK(clk),
    .D(_0013_),
    .Q(\cpu_inst.regfile_inst.registers[6][13] ));
 sky130_fd_sc_hd__dfxtp_1 _5094_ (.CLK(clk),
    .D(_0014_),
    .Q(\cpu_inst.regfile_inst.registers[6][14] ));
 sky130_fd_sc_hd__dfxtp_1 _5095_ (.CLK(clk),
    .D(_0015_),
    .Q(\cpu_inst.regfile_inst.registers[6][15] ));
 sky130_fd_sc_hd__dfxtp_1 _5096_ (.CLK(clk),
    .D(_0016_),
    .Q(\cpu_inst.regfile_inst.registers[6][16] ));
 sky130_fd_sc_hd__dfxtp_1 _5097_ (.CLK(clk),
    .D(_0017_),
    .Q(\cpu_inst.regfile_inst.registers[6][17] ));
 sky130_fd_sc_hd__dfxtp_1 _5098_ (.CLK(clk),
    .D(_0018_),
    .Q(\cpu_inst.regfile_inst.registers[6][18] ));
 sky130_fd_sc_hd__dfxtp_1 _5099_ (.CLK(clk),
    .D(_0019_),
    .Q(\cpu_inst.regfile_inst.registers[6][19] ));
 sky130_fd_sc_hd__dfxtp_1 _5100_ (.CLK(clk),
    .D(_0020_),
    .Q(\cpu_inst.regfile_inst.registers[6][20] ));
 sky130_fd_sc_hd__dfxtp_1 _5101_ (.CLK(clk),
    .D(_0021_),
    .Q(\cpu_inst.regfile_inst.registers[6][21] ));
 sky130_fd_sc_hd__dfxtp_1 _5102_ (.CLK(clk),
    .D(_0022_),
    .Q(\cpu_inst.regfile_inst.registers[6][22] ));
 sky130_fd_sc_hd__dfxtp_1 _5103_ (.CLK(clk),
    .D(_0023_),
    .Q(\cpu_inst.regfile_inst.registers[6][23] ));
 sky130_fd_sc_hd__dfxtp_1 _5104_ (.CLK(clk),
    .D(_0024_),
    .Q(\cpu_inst.regfile_inst.registers[6][24] ));
 sky130_fd_sc_hd__dfxtp_1 _5105_ (.CLK(clk),
    .D(_0025_),
    .Q(\cpu_inst.regfile_inst.registers[6][25] ));
 sky130_fd_sc_hd__dfxtp_1 _5106_ (.CLK(clk),
    .D(_0026_),
    .Q(\cpu_inst.regfile_inst.registers[6][26] ));
 sky130_fd_sc_hd__dfxtp_1 _5107_ (.CLK(clk),
    .D(_0027_),
    .Q(\cpu_inst.regfile_inst.registers[6][27] ));
 sky130_fd_sc_hd__dfxtp_1 _5108_ (.CLK(clk),
    .D(_0028_),
    .Q(\cpu_inst.regfile_inst.registers[6][28] ));
 sky130_fd_sc_hd__dfxtp_1 _5109_ (.CLK(clk),
    .D(_0029_),
    .Q(\cpu_inst.regfile_inst.registers[6][29] ));
 sky130_fd_sc_hd__dfxtp_1 _5110_ (.CLK(clk),
    .D(_0030_),
    .Q(\cpu_inst.regfile_inst.registers[6][30] ));
 sky130_fd_sc_hd__dfxtp_1 _5111_ (.CLK(clk),
    .D(_0031_),
    .Q(\cpu_inst.regfile_inst.registers[6][31] ));
 sky130_fd_sc_hd__dfxtp_1 _5112_ (.CLK(clk),
    .D(_0032_),
    .Q(\cpu_inst.regfile_inst.registers[2][0] ));
 sky130_fd_sc_hd__dfxtp_1 _5113_ (.CLK(clk),
    .D(_0033_),
    .Q(\cpu_inst.regfile_inst.registers[2][1] ));
 sky130_fd_sc_hd__dfxtp_1 _5114_ (.CLK(clk),
    .D(_0034_),
    .Q(\cpu_inst.regfile_inst.registers[2][2] ));
 sky130_fd_sc_hd__dfxtp_1 _5115_ (.CLK(clk),
    .D(_0035_),
    .Q(\cpu_inst.regfile_inst.registers[2][3] ));
 sky130_fd_sc_hd__dfxtp_1 _5116_ (.CLK(clk),
    .D(_0036_),
    .Q(\cpu_inst.regfile_inst.registers[2][4] ));
 sky130_fd_sc_hd__dfxtp_1 _5117_ (.CLK(clk),
    .D(_0037_),
    .Q(\cpu_inst.regfile_inst.registers[2][5] ));
 sky130_fd_sc_hd__dfxtp_1 _5118_ (.CLK(clk),
    .D(_0038_),
    .Q(\cpu_inst.regfile_inst.registers[2][6] ));
 sky130_fd_sc_hd__dfxtp_1 _5119_ (.CLK(clk),
    .D(_0039_),
    .Q(\cpu_inst.regfile_inst.registers[2][7] ));
 sky130_fd_sc_hd__dfxtp_1 _5120_ (.CLK(clk),
    .D(_0040_),
    .Q(\cpu_inst.regfile_inst.registers[2][8] ));
 sky130_fd_sc_hd__dfxtp_1 _5121_ (.CLK(clk),
    .D(_0041_),
    .Q(\cpu_inst.regfile_inst.registers[2][9] ));
 sky130_fd_sc_hd__dfxtp_1 _5122_ (.CLK(clk),
    .D(_0042_),
    .Q(\cpu_inst.regfile_inst.registers[2][10] ));
 sky130_fd_sc_hd__dfxtp_1 _5123_ (.CLK(clk),
    .D(_0043_),
    .Q(\cpu_inst.regfile_inst.registers[2][11] ));
 sky130_fd_sc_hd__dfxtp_1 _5124_ (.CLK(clk),
    .D(_0044_),
    .Q(\cpu_inst.regfile_inst.registers[2][12] ));
 sky130_fd_sc_hd__dfxtp_1 _5125_ (.CLK(clk),
    .D(_0045_),
    .Q(\cpu_inst.regfile_inst.registers[2][13] ));
 sky130_fd_sc_hd__dfxtp_1 _5126_ (.CLK(clk),
    .D(_0046_),
    .Q(\cpu_inst.regfile_inst.registers[2][14] ));
 sky130_fd_sc_hd__dfxtp_1 _5127_ (.CLK(clk),
    .D(_0047_),
    .Q(\cpu_inst.regfile_inst.registers[2][15] ));
 sky130_fd_sc_hd__dfxtp_1 _5128_ (.CLK(clk),
    .D(_0048_),
    .Q(\cpu_inst.regfile_inst.registers[2][16] ));
 sky130_fd_sc_hd__dfxtp_1 _5129_ (.CLK(clk),
    .D(_0049_),
    .Q(\cpu_inst.regfile_inst.registers[2][17] ));
 sky130_fd_sc_hd__dfxtp_1 _5130_ (.CLK(clk),
    .D(_0050_),
    .Q(\cpu_inst.regfile_inst.registers[2][18] ));
 sky130_fd_sc_hd__dfxtp_1 _5131_ (.CLK(clk),
    .D(_0051_),
    .Q(\cpu_inst.regfile_inst.registers[2][19] ));
 sky130_fd_sc_hd__dfxtp_1 _5132_ (.CLK(clk),
    .D(_0052_),
    .Q(\cpu_inst.regfile_inst.registers[2][20] ));
 sky130_fd_sc_hd__dfxtp_1 _5133_ (.CLK(clk),
    .D(_0053_),
    .Q(\cpu_inst.regfile_inst.registers[2][21] ));
 sky130_fd_sc_hd__dfxtp_1 _5134_ (.CLK(clk),
    .D(_0054_),
    .Q(\cpu_inst.regfile_inst.registers[2][22] ));
 sky130_fd_sc_hd__dfxtp_1 _5135_ (.CLK(clk),
    .D(_0055_),
    .Q(\cpu_inst.regfile_inst.registers[2][23] ));
 sky130_fd_sc_hd__dfxtp_1 _5136_ (.CLK(clk),
    .D(_0056_),
    .Q(\cpu_inst.regfile_inst.registers[2][24] ));
 sky130_fd_sc_hd__dfxtp_1 _5137_ (.CLK(clk),
    .D(_0057_),
    .Q(\cpu_inst.regfile_inst.registers[2][25] ));
 sky130_fd_sc_hd__dfxtp_1 _5138_ (.CLK(clk),
    .D(_0058_),
    .Q(\cpu_inst.regfile_inst.registers[2][26] ));
 sky130_fd_sc_hd__dfxtp_1 _5139_ (.CLK(clk),
    .D(_0059_),
    .Q(\cpu_inst.regfile_inst.registers[2][27] ));
 sky130_fd_sc_hd__dfxtp_1 _5140_ (.CLK(clk),
    .D(_0060_),
    .Q(\cpu_inst.regfile_inst.registers[2][28] ));
 sky130_fd_sc_hd__dfxtp_1 _5141_ (.CLK(clk),
    .D(_0061_),
    .Q(\cpu_inst.regfile_inst.registers[2][29] ));
 sky130_fd_sc_hd__dfxtp_1 _5142_ (.CLK(clk),
    .D(_0062_),
    .Q(\cpu_inst.regfile_inst.registers[2][30] ));
 sky130_fd_sc_hd__dfxtp_1 _5143_ (.CLK(clk),
    .D(_0063_),
    .Q(\cpu_inst.regfile_inst.registers[2][31] ));
 sky130_fd_sc_hd__dfxtp_1 _5144_ (.CLK(clk),
    .D(_0064_),
    .Q(\cpu_inst.regfile_inst.registers[25][0] ));
 sky130_fd_sc_hd__dfxtp_1 _5145_ (.CLK(clk),
    .D(_0065_),
    .Q(\cpu_inst.regfile_inst.registers[25][1] ));
 sky130_fd_sc_hd__dfxtp_1 _5146_ (.CLK(clk),
    .D(_0066_),
    .Q(\cpu_inst.regfile_inst.registers[25][2] ));
 sky130_fd_sc_hd__dfxtp_1 _5147_ (.CLK(clk),
    .D(_0067_),
    .Q(\cpu_inst.regfile_inst.registers[25][3] ));
 sky130_fd_sc_hd__dfxtp_1 _5148_ (.CLK(clk),
    .D(_0068_),
    .Q(\cpu_inst.regfile_inst.registers[25][4] ));
 sky130_fd_sc_hd__dfxtp_1 _5149_ (.CLK(clk),
    .D(_0069_),
    .Q(\cpu_inst.regfile_inst.registers[25][5] ));
 sky130_fd_sc_hd__dfxtp_1 _5150_ (.CLK(clk),
    .D(_0070_),
    .Q(\cpu_inst.regfile_inst.registers[25][6] ));
 sky130_fd_sc_hd__dfxtp_1 _5151_ (.CLK(clk),
    .D(_0071_),
    .Q(\cpu_inst.regfile_inst.registers[25][7] ));
 sky130_fd_sc_hd__dfxtp_1 _5152_ (.CLK(clk),
    .D(_0072_),
    .Q(\cpu_inst.regfile_inst.registers[25][8] ));
 sky130_fd_sc_hd__dfxtp_1 _5153_ (.CLK(clk),
    .D(_0073_),
    .Q(\cpu_inst.regfile_inst.registers[25][9] ));
 sky130_fd_sc_hd__dfxtp_1 _5154_ (.CLK(clk),
    .D(_0074_),
    .Q(\cpu_inst.regfile_inst.registers[25][10] ));
 sky130_fd_sc_hd__dfxtp_1 _5155_ (.CLK(clk),
    .D(_0075_),
    .Q(\cpu_inst.regfile_inst.registers[25][11] ));
 sky130_fd_sc_hd__dfxtp_1 _5156_ (.CLK(clk),
    .D(_0076_),
    .Q(\cpu_inst.regfile_inst.registers[25][12] ));
 sky130_fd_sc_hd__dfxtp_1 _5157_ (.CLK(clk),
    .D(_0077_),
    .Q(\cpu_inst.regfile_inst.registers[25][13] ));
 sky130_fd_sc_hd__dfxtp_1 _5158_ (.CLK(clk),
    .D(_0078_),
    .Q(\cpu_inst.regfile_inst.registers[25][14] ));
 sky130_fd_sc_hd__dfxtp_1 _5159_ (.CLK(clk),
    .D(_0079_),
    .Q(\cpu_inst.regfile_inst.registers[25][15] ));
 sky130_fd_sc_hd__dfxtp_1 _5160_ (.CLK(clk),
    .D(_0080_),
    .Q(\cpu_inst.regfile_inst.registers[25][16] ));
 sky130_fd_sc_hd__dfxtp_1 _5161_ (.CLK(clk),
    .D(_0081_),
    .Q(\cpu_inst.regfile_inst.registers[25][17] ));
 sky130_fd_sc_hd__dfxtp_1 _5162_ (.CLK(clk),
    .D(_0082_),
    .Q(\cpu_inst.regfile_inst.registers[25][18] ));
 sky130_fd_sc_hd__dfxtp_1 _5163_ (.CLK(clk),
    .D(_0083_),
    .Q(\cpu_inst.regfile_inst.registers[25][19] ));
 sky130_fd_sc_hd__dfxtp_1 _5164_ (.CLK(clk),
    .D(_0084_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5176_ (.CLK(clk),
    .D(_0096_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5180_ (.CLK(clk),
    .D(_0100_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5192_ (.CLK(clk),
    .D(_0112_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5196_ (.CLK(clk),
    .D(_0116_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5200_ (.CLK(clk),
    .D(_0120_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5204_ (.CLK(clk),
    .D(_0124_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5208_ (.CLK(clk),
    .D(_0128_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5212_ (.CLK(clk),
    .D(_0132_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5216_ (.CLK(clk),
    .D(_0136_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5220_ (.CLK(clk),
    .D(_0140_),
    .Q(\cpu_inst.regfile_inst.registers[24][12] ));
 sky130_fd_sc_hd__dfxtp_1 _5221_ (.CLK(clk),
    .D(_0141_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5228_ (.CLK(clk),
    .D(_0148_),
    .Q(\cpu_inst.regfile_inst.registers[24][20] ));
 sky130_fd_sc_hd__dfxtp_1 _5229_ (.CLK(clk),
    .D(_0149_),
    .Q(\cpu_inst.regfile_inst.registers[24][21] ));
 sky130_fd_sc_hd__dfxtp_1 _5230_ (.CLK(clk),
    .D(_0150_),
    .Q(\cpu_inst.regfile_inst.registers[24][22] ));
 sky130_fd_sc_hd__dfxtp_1 _5231_ (.CLK(clk),
    .D(_0151_),
    .Q(\cpu_inst.regfile_inst.registers[24][23] ));
 sky130_fd_sc_hd__dfxtp_1 _5232_ (.CLK(clk),
    .D(_0152_),
    .Q(\cpu_inst.regfile_inst.registers[24][24] ));
 sky130_fd_sc_hd__dfxtp_1 _5233_ (.CLK(clk),
    .D(_0153_),
    .Q(\cpu_inst.regfile_inst.registers[24][25] ));
 sky130_fd_sc_hd__dfxtp_1 _5234_ (.CLK(clk),
    .D(_0154_),
    .Q(\cpu_inst.regfile_inst.registers[24][26] ));
 sky130_fd_sc_hd__dfxtp_1 _5235_ (.CLK(clk),
    .D(_0155_),
    .Q(\cpu_inst.regfile_inst.registers[24][27] ));
 sky130_fd_sc_hd__dfxtp_1 _5236_ (.CLK(clk),
    .D(_0156_),
    .Q(\cpu_inst.regfile_inst.registers[24][28] ));
 sky130_fd_sc_hd__dfxtp_1 _5237_ (.CLK(clk),
    .D(_0157_),
    .Q(\cpu_inst.regfile_inst.registers[24][29] ));
 sky130_fd_sc_hd__dfxtp_1 _5238_ (.CLK(clk),
    .D(_0158_),
    .Q(\cpu_inst.regfile_inst.registers[24][30] ));
 sky130_fd_sc_hd__dfxtp_1 _5239_ (.CLK(clk),
    .D(_0159_),
    .Q(\cpu_inst.regfile_inst.registers[24][31] ));
 sky130_fd_sc_hd__dfxtp_1 _5240_ (.CLK(clk),
    .D(_0160_),
    .Q(\cpu_inst.regfile_inst.registers[5][0] ));
 sky130_fd_sc_hd__dfxtp_1 _5241_ (.CLK(clk),
    .D(_0161_),
    .Q(\cpu_inst.regfile_inst.registers[5][1] ));
 sky130_fd_sc_hd__dfxtp_1 _5242_ (.CLK(clk),
    .D(_0162_),
    .Q(\cpu_inst.regfile_inst.registers[5][2] ));
 sky130_fd_sc_hd__dfxtp_1 _5243_ (.CLK(clk),
    .D(_0163_),
    .Q(\cpu_inst.regfile_inst.registers[5][3] ));
 sky130_fd_sc_hd__dfxtp_1 _5244_ (.CLK(clk),
    .D(_0164_),
    .Q(\cpu_inst.regfile_inst.registers[5][4] ));
 sky130_fd_sc_hd__dfxtp_1 _5245_ (.CLK(clk),
    .D(_0165_),
    .Q(\cpu_inst.regfile_inst.registers[5][5] ));
 sky130_fd_sc_hd__dfxtp_1 _5246_ (.CLK(clk),
    .D(_0166_),
    .Q(\cpu_inst.regfile_inst.registers[5][6] ));
 sky130_fd_sc_hd__dfxtp_1 _5247_ (.CLK(clk),
    .D(_0167_),
    .Q(\cpu_inst.regfile_inst.registers[5][7] ));
 sky130_fd_sc_hd__dfxtp_1 _5248_ (.CLK(clk),
    .D(_0168_),
    .Q(\cpu_inst.regfile_inst.registers[5][8] ));
 sky130_fd_sc_hd__dfxtp_1 _5249_ (.CLK(clk),
    .D(_0169_),
    .Q(\cpu_inst.regfile_inst.registers[5][9] ));
 sky130_fd_sc_hd__dfxtp_1 _5250_ (.CLK(clk),
    .D(_0170_),
    .Q(\cpu_inst.regfile_inst.registers[5][10] ));
 sky130_fd_sc_hd__dfxtp_1 _5251_ (.CLK(clk),
    .D(_0171_),
    .Q(\cpu_inst.regfile_inst.registers[5][11] ));
 sky130_fd_sc_hd__dfxtp_1 _5252_ (.CLK(clk),
    .D(_0172_),
    .Q(\cpu_inst.regfile_inst.registers[5][12] ));
 sky130_fd_sc_hd__dfxtp_1 _5253_ (.CLK(clk),
    .D(_0173_),
    .Q(\cpu_inst.regfile_inst.registers[5][13] ));
 sky130_fd_sc_hd__dfxtp_1 _5254_ (.CLK(clk),
    .D(_0174_),
    .Q(\cpu_inst.regfile_inst.registers[5][14] ));
 sky130_fd_sc_hd__dfxtp_1 _5255_ (.CLK(clk),
    .D(_0175_),
    .Q(\cpu_inst.regfile_inst.registers[5][15] ));
 sky130_fd_sc_hd__dfxtp_1 _5256_ (.CLK(clk),
    .D(_0176_),
    .Q(\cpu_inst.regfile_inst.registers[5][16] ));
 sky130_fd_sc_hd__dfxtp_1 _5257_ (.CLK(clk),
    .D(_0177_),
    .Q(\cpu_inst.regfile_inst.registers[5][17] ));
 sky130_fd_sc_hd__dfxtp_1 _5258_ (.CLK(clk),
    .D(_0178_),
    .Q(\cpu_inst.regfile_inst.registers[5][18] ));
 sky130_fd_sc_hd__dfxtp_1 _5259_ (.CLK(clk),
    .D(_0179_),
    .Q(\cpu_inst.regfile_inst.registers[5][19] ));
 sky130_fd_sc_hd__dfxtp_1 _5260_ (.CLK(clk),
    .D(_0180_),
    .Q(\cpu_inst.regfile_inst.registers[5][20] ));
 sky130_fd_sc_hd__dfxtp_1 _5261_ (.CLK(clk),
    .D(_0181_),
    .Q(\cpu_inst.regfile_inst.registers[5][21] ));
 sky130_fd_sc_hd__dfxtp_1 _5262_ (.CLK(clk),
    .D(_0182_),
    .Q(\cpu_inst.regfile_inst.registers[5][22] ));
 sky130_fd_sc_hd__dfxtp_1 _5263_ (.CLK(clk),
    .D(_0183_),
    .Q(\cpu_inst.regfile_inst.registers[5][23] ));
 sky130_fd_sc_hd__dfxtp_1 _5264_ (.CLK(clk),
    .D(_0184_),
    .Q(\cpu_inst.regfile_inst.registers[5][24] ));
 sky130_fd_sc_hd__dfxtp_1 _5265_ (.CLK(clk),
    .D(_0185_),
    .Q(\cpu_inst.regfile_inst.registers[5][25] ));
 sky130_fd_sc_hd__dfxtp_1 _5266_ (.CLK(clk),
    .D(_0186_),
    .Q(\cpu_inst.regfile_inst.registers[5][26] ));
 sky130_fd_sc_hd__dfxtp_1 _5267_ (.CLK(clk),
    .D(_0187_),
    .Q(\cpu_inst.regfile_inst.registers[5][27] ));
 sky130_fd_sc_hd__dfxtp_1 _5268_ (.CLK(clk),
    .D(_0188_),
    .Q(\cpu_inst.regfile_inst.registers[5][28] ));
 sky130_fd_sc_hd__dfxtp_1 _5269_ (.CLK(clk),
    .D(_0189_),
    .Q(\cpu_inst.regfile_inst.registers[5][29] ));
 sky130_fd_sc_hd__dfxtp_1 _5270_ (.CLK(clk),
    .D(_0190_),
    .Q(\cpu_inst.regfile_inst.registers[5][30] ));
 sky130_fd_sc_hd__dfxtp_1 _5271_ (.CLK(clk),
    .D(_0191_),
    .Q(\cpu_inst.regfile_inst.registers[5][31] ));
 sky130_fd_sc_hd__dfxtp_1 _5272_ (.CLK(clk),
    .D(_0192_),
    .Q(\cpu_inst.regfile_inst.registers[1][0] ));
 sky130_fd_sc_hd__dfxtp_1 _5273_ (.CLK(clk),
    .D(_0193_),
    .Q(\cpu_inst.regfile_inst.registers[1][1] ));
 sky130_fd_sc_hd__dfxtp_1 _5274_ (.CLK(clk),
    .D(_0194_),
    .Q(\cpu_inst.regfile_inst.registers[1][2] ));
 sky130_fd_sc_hd__dfxtp_1 _5275_ (.CLK(clk),
    .D(_0195_),
    .Q(\cpu_inst.regfile_inst.registers[1][3] ));
 sky130_fd_sc_hd__dfxtp_1 _5276_ (.CLK(clk),
    .D(_0196_),
    .Q(\cpu_inst.regfile_inst.registers[1][4] ));
 sky130_fd_sc_hd__dfxtp_1 _5277_ (.CLK(clk),
    .D(_0197_),
    .Q(\cpu_inst.regfile_inst.registers[1][5] ));
 sky130_fd_sc_hd__dfxtp_1 _5278_ (.CLK(clk),
    .D(_0198_),
    .Q(\cpu_inst.regfile_inst.registers[1][6] ));
 sky130_fd_sc_hd__dfxtp_1 _5279_ (.CLK(clk),
    .D(_0199_),
    .Q(\cpu_inst.regfile_inst.registers[1][7] ));
 sky130_fd_sc_hd__dfxtp_1 _5280_ (.CLK(clk),
    .D(_0200_),
    .Q(\cpu_inst.regfile_inst.registers[1][8] ));
 sky130_fd_sc_hd__dfxtp_1 _5281_ (.CLK(clk),
    .D(_0201_),
    .Q(\cpu_inst.regfile_inst.registers[1][9] ));
 sky130_fd_sc_hd__dfxtp_1 _5282_ (.CLK(clk),
    .D(_0202_),
    .Q(\cpu_inst.regfile_inst.registers[1][10] ));
 sky130_fd_sc_hd__dfxtp_1 _5283_ (.CLK(clk),
    .D(_0203_),
    .Q(\cpu_inst.regfile_inst.registers[1][11] ));
 sky130_fd_sc_hd__dfxtp_1 _5284_ (.CLK(clk),
    .D(_0204_),
    .Q(\cpu_inst.regfile_inst.registers[1][12] ));
 sky130_fd_sc_hd__dfxtp_1 _5285_ (.CLK(clk),
    .D(_0205_),
    .Q(\cpu_inst.regfile_inst.registers[1][13] ));
 sky130_fd_sc_hd__dfxtp_1 _5286_ (.CLK(clk),
    .D(_0206_),
    .Q(\cpu_inst.regfile_inst.registers[1][14] ));
 sky130_fd_sc_hd__dfxtp_1 _5287_ (.CLK(clk),
    .D(_0207_),
    .Q(\cpu_inst.regfile_inst.registers[1][15] ));
 sky130_fd_sc_hd__dfxtp_1 _5288_ (.CLK(clk),
    .D(_0208_),
    .Q(\cpu_inst.regfile_inst.registers[1][16] ));
 sky130_fd_sc_hd__dfxtp_1 _5289_ (.CLK(clk),
    .D(_0209_),
    .Q(\cpu_inst.regfile_inst.registers[1][17] ));
 sky130_fd_sc_hd__dfxtp_1 _5290_ (.CLK(clk),
    .D(_0210_),
    .Q(\cpu_inst.regfile_inst.registers[1][18] ));
 sky130_fd_sc_hd__dfxtp_1 _5291_ (.CLK(clk),
    .D(_0211_),
    .Q(\cpu_inst.regfile_inst.registers[1][19] ));
 sky130_fd_sc_hd__dfxtp_1 _5292_ (.CLK(clk),
    .D(_0212_),
    .Q(\cpu_inst.regfile_inst.registers[1][20] ));
 sky130_fd_sc_hd__dfxtp_1 _5293_ (.CLK(clk),
    .D(_0213_),
    .Q(\cpu_inst.regfile_inst.registers[1][21] ));
 sky130_fd_sc_hd__dfxtp_1 _5294_ (.CLK(clk),
    .D(_0214_),
    .Q(\cpu_inst.regfile_inst.registers[1][22] ));
 sky130_fd_sc_hd__dfxtp_1 _5295_ (.CLK(clk),
    .D(_0215_),
    .Q(\cpu_inst.regfile_inst.registers[1][23] ));
 sky130_fd_sc_hd__dfxtp_1 _5296_ (.CLK(clk),
    .D(_0216_),
    .Q(\cpu_inst.regfile_inst.registers[1][24] ));
 sky130_fd_sc_hd__dfxtp_1 _5297_ (.CLK(clk),
    .D(_0217_),
    .Q(\cpu_inst.regfile_inst.registers[1][25] ));
 sky130_fd_sc_hd__dfxtp_1 _5298_ (.CLK(clk),
    .D(_0218_),
    .Q(\cpu_inst.regfile_inst.registers[1][26] ));
 sky130_fd_sc_hd__dfxtp_1 _5299_ (.CLK(clk),
    .D(_0219_),
    .Q(\cpu_inst.regfile_inst.registers[1][27] ));
 sky130_fd_sc_hd__dfxtp_1 _5300_ (.CLK(clk),
    .D(_0220_),
    .Q(\cpu_inst.regfile_inst.registers[1][28] ));
 sky130_fd_sc_hd__dfxtp_1 _5301_ (.CLK(clk),
    .D(_0221_),
    .Q(\cpu_inst.regfile_inst.registers[1][29] ));
 sky130_fd_sc_hd__dfxtp_1 _5302_ (.CLK(clk),
    .D(_0222_),
    .Q(\cpu_inst.regfile_inst.registers[1][30] ));
 sky130_fd_sc_hd__dfxtp_1 _5303_ (.CLK(clk),
    .D(_0223_),
    .Q(\cpu_inst.regfile_inst.registers[1][31] ));
 sky130_fd_sc_hd__dfxtp_1 _5304_ (.CLK(clk),
    .D(_0224_),
    .Q(\cpu_inst.regfile_inst.registers[7][0] ));
 sky130_fd_sc_hd__dfxtp_1 _5305_ (.CLK(clk),
    .D(_0225_),
    .Q(\cpu_inst.regfile_inst.registers[7][1] ));
 sky130_fd_sc_hd__dfxtp_1 _5306_ (.CLK(clk),
    .D(_0226_),
    .Q(\cpu_inst.regfile_inst.registers[7][2] ));
 sky130_fd_sc_hd__dfxtp_1 _5307_ (.CLK(clk),
    .D(_0227_),
    .Q(\cpu_inst.regfile_inst.registers[7][3] ));
 sky130_fd_sc_hd__dfxtp_1 _5308_ (.CLK(clk),
    .D(_0228_),
    .Q(\cpu_inst.regfile_inst.registers[7][4] ));
 sky130_fd_sc_hd__dfxtp_1 _5309_ (.CLK(clk),
    .D(_0229_),
    .Q(\cpu_inst.regfile_inst.registers[7][5] ));
 sky130_fd_sc_hd__dfxtp_1 _5310_ (.CLK(clk),
    .D(_0230_),
    .Q(\cpu_inst.regfile_inst.registers[7][6] ));
 sky130_fd_sc_hd__dfxtp_1 _5311_ (.CLK(clk),
    .D(_0231_),
    .Q(\cpu_inst.regfile_inst.registers[7][7] ));
 sky130_fd_sc_hd__dfxtp_1 _5312_ (.CLK(clk),
    .D(_0232_),
    .Q(\cpu_inst.regfile_inst.registers[7][8] ));
 sky130_fd_sc_hd__dfxtp_1 _5313_ (.CLK(clk),
    .D(_0233_),
    .Q(\cpu_inst.regfile_inst.registers[7][9] ));
 sky130_fd_sc_hd__dfxtp_1 _5314_ (.CLK(clk),
    .D(_0234_),
    .Q(\cpu_inst.regfile_inst.registers[7][10] ));
 sky130_fd_sc_hd__dfxtp_1 _5315_ (.CLK(clk),
    .D(_0235_),
    .Q(\cpu_inst.regfile_inst.registers[7][11] ));
 sky130_fd_sc_hd__dfxtp_1 _5316_ (.CLK(clk),
    .D(_0236_),
    .Q(\cpu_inst.regfile_inst.registers[7][12] ));
 sky130_fd_sc_hd__dfxtp_1 _5317_ (.CLK(clk),
    .D(_0237_),
    .Q(\cpu_inst.regfile_inst.registers[7][13] ));
 sky130_fd_sc_hd__dfxtp_1 _5318_ (.CLK(clk),
    .D(_0238_),
    .Q(\cpu_inst.regfile_inst.registers[7][14] ));
 sky130_fd_sc_hd__dfxtp_1 _5319_ (.CLK(clk),
    .D(_0239_),
    .Q(\cpu_inst.regfile_inst.registers[7][15] ));
 sky130_fd_sc_hd__dfxtp_1 _5320_ (.CLK(clk),
    .D(_0240_),
    .Q(\cpu_inst.regfile_inst.registers[7][16] ));
 sky130_fd_sc_hd__dfxtp_1 _5321_ (.CLK(clk),
    .D(_0241_),
    .Q(\cpu_inst.regfile_inst.registers[7][17] ));
 sky130_fd_sc_hd__dfxtp_1 _5322_ (.CLK(clk),
    .D(_0242_),
    .Q(\cpu_inst.regfile_inst.registers[7][18] ));
 sky130_fd_sc_hd__dfxtp_1 _5323_ (.CLK(clk),
    .D(_0243_),
    .Q(\cpu_inst.regfile_inst.registers[7][19] ));
 sky130_fd_sc_hd__dfxtp_1 _5324_ (.CLK(clk),
    .D(_0244_),
    .Q(\cpu_inst.regfile_inst.registers[7][20] ));
 sky130_fd_sc_hd__dfxtp_1 _5325_ (.CLK(clk),
    .D(_0245_),
    .Q(\cpu_inst.regfile_inst.registers[7][21] ));
 sky130_fd_sc_hd__dfxtp_1 _5326_ (.CLK(clk),
    .D(_0246_),
    .Q(\cpu_inst.regfile_inst.registers[7][22] ));
 sky130_fd_sc_hd__dfxtp_1 _5327_ (.CLK(clk),
    .D(_0247_),
    .Q(\cpu_inst.regfile_inst.registers[7][23] ));
 sky130_fd_sc_hd__dfxtp_1 _5328_ (.CLK(clk),
    .D(_0248_),
    .Q(\cpu_inst.regfile_inst.registers[7][24] ));
 sky130_fd_sc_hd__dfxtp_1 _5329_ (.CLK(clk),
    .D(_0249_),
    .Q(\cpu_inst.regfile_inst.registers[7][25] ));
 sky130_fd_sc_hd__dfxtp_1 _5330_ (.CLK(clk),
    .D(_0250_),
    .Q(\cpu_inst.regfile_inst.registers[7][26] ));
 sky130_fd_sc_hd__dfxtp_1 _5331_ (.CLK(clk),
    .D(_0251_),
    .Q(\cpu_inst.regfile_inst.registers[7][27] ));
 sky130_fd_sc_hd__dfxtp_1 _5332_ (.CLK(clk),
    .D(_0252_),
    .Q(\cpu_inst.regfile_inst.registers[7][28] ));
 sky130_fd_sc_hd__dfxtp_1 _5333_ (.CLK(clk),
    .D(_0253_),
    .Q(\cpu_inst.regfile_inst.registers[7][29] ));
 sky130_fd_sc_hd__dfxtp_1 _5334_ (.CLK(clk),
    .D(_0254_),
    .Q(\cpu_inst.regfile_inst.registers[7][30] ));
 sky130_fd_sc_hd__dfxtp_1 _5335_ (.CLK(clk),
    .D(_0255_),
    .Q(\cpu_inst.regfile_inst.registers[7][31] ));
 sky130_fd_sc_hd__dfxtp_1 _5336_ (.CLK(clk),
    .D(_0256_),
    .Q(\cpu_inst.regfile_inst.registers[11][0] ));
 sky130_fd_sc_hd__dfxtp_1 _5337_ (.CLK(clk),
    .D(_0257_),
    .Q(\cpu_inst.regfile_inst.registers[11][1] ));
 sky130_fd_sc_hd__dfxtp_1 _5338_ (.CLK(clk),
    .D(_0258_),
    .Q(\cpu_inst.regfile_inst.registers[11][2] ));
 sky130_fd_sc_hd__dfxtp_1 _5339_ (.CLK(clk),
    .D(_0259_),
    .Q(\cpu_inst.regfile_inst.registers[11][3] ));
 sky130_fd_sc_hd__dfxtp_1 _5340_ (.CLK(clk),
    .D(_0260_),
    .Q(\cpu_inst.regfile_inst.registers[11][4] ));
 sky130_fd_sc_hd__dfxtp_1 _5341_ (.CLK(clk),
    .D(_0261_),
    .Q(\cpu_inst.regfile_inst.registers[11][5] ));
 sky130_fd_sc_hd__dfxtp_1 _5342_ (.CLK(clk),
    .D(_0262_),
    .Q(\cpu_inst.regfile_inst.registers[11][6] ));
 sky130_fd_sc_hd__dfxtp_1 _5343_ (.CLK(clk),
    .D(_0263_),
    .Q(\cpu_inst.regfile_inst.registers[11][7] ));
 sky130_fd_sc_hd__dfxtp_1 _5344_ (.CLK(clk),
    .D(_0264_),
    .Q(\cpu_inst.regfile_inst.registers[11][8] ));
 sky130_fd_sc_hd__dfxtp_1 _5345_ (.CLK(clk),
    .D(_0265_),
    .Q(\cpu_inst.regfile_inst.registers[11][9] ));
 sky130_fd_sc_hd__dfxtp_1 _5346_ (.CLK(clk),
    .D(_0266_),
    .Q(\cpu_inst.regfile_inst.registers[11][10] ));
 sky130_fd_sc_hd__dfxtp_1 _5347_ (.CLK(clk),
    .D(_0267_),
    .Q(\cpu_inst.regfile_inst.registers[11][11] ));
 sky130_fd_sc_hd__dfxtp_1 _5348_ (.CLK(clk),
    .D(_0268_),
    .Q(\cpu_inst.regfile_inst.registers[11][12] ));
 sky130_fd_sc_hd__dfxtp_1 _5349_ (.CLK(clk),
    .D(_0269_),
    .Q(\cpu_inst.regfile_inst.registers[11][13] ));
 sky130_fd_sc_hd__dfxtp_1 _5350_ (.CLK(clk),
    .D(_0270_),
    .Q(\cpu_inst.regfile_inst.registers[11][14] ));
 sky130_fd_sc_hd__dfxtp_1 _5351_ (.CLK(clk),
    .D(_0271_),
    .Q(\cpu_inst.regfile_inst.registers[11][15] ));
 sky130_fd_sc_hd__dfxtp_1 _5352_ (.CLK(clk),
    .D(_0272_),
    .Q(\cpu_inst.regfile_inst.registers[11][16] ));
 sky130_fd_sc_hd__dfxtp_1 _5353_ (.CLK(clk),
    .D(_0273_),
    .Q(\cpu_inst.regfile_inst.registers[11][17] ));
 sky130_fd_sc_hd__dfxtp_1 _5354_ (.CLK(clk),
    .D(_0274_),
    .Q(\cpu_inst.regfile_inst.registers[11][18] ));
 sky130_fd_sc_hd__dfxtp_1 _5355_ (.CLK(clk),
    .D(_0275_),
    .Q(\cpu_inst.regfile_inst.registers[11][19] ));
 sky130_fd_sc_hd__dfxtp_1 _5356_ (.CLK(clk),
    .D(_0276_),
    .Q(\cpu_inst.regfile_inst.registers[11][20] ));
 sky130_fd_sc_hd__dfxtp_1 _5357_ (.CLK(clk),
    .D(_0277_),
    .Q(\cpu_inst.regfile_inst.registers[11][21] ));
 sky130_fd_sc_hd__dfxtp_1 _5358_ (.CLK(clk),
    .D(_0278_),
    .Q(\cpu_inst.regfile_inst.registers[11][22] ));
 sky130_fd_sc_hd__dfxtp_1 _5359_ (.CLK(clk),
    .D(_0279_),
    .Q(\cpu_inst.regfile_inst.registers[11][23] ));
 sky130_fd_sc_hd__dfxtp_1 _5360_ (.CLK(clk),
    .D(_0280_),
    .Q(\cpu_inst.regfile_inst.registers[11][24] ));
 sky130_fd_sc_hd__dfxtp_1 _5361_ (.CLK(clk),
    .D(_0281_),
    .Q(\cpu_inst.regfile_inst.registers[11][25] ));
 sky130_fd_sc_hd__dfxtp_1 _5362_ (.CLK(clk),
    .D(_0282_),
    .Q(\cpu_inst.regfile_inst.registers[11][26] ));
 sky130_fd_sc_hd__dfxtp_1 _5363_ (.CLK(clk),
    .D(_0283_),
    .Q(\cpu_inst.regfile_inst.registers[11][27] ));
 sky130_fd_sc_hd__dfxtp_1 _5364_ (.CLK(clk),
    .D(_0284_),
    .Q(\cpu_inst.regfile_inst.registers[11][28] ));
 sky130_fd_sc_hd__dfxtp_1 _5365_ (.CLK(clk),
    .D(_0285_),
    .Q(\cpu_inst.regfile_inst.registers[11][29] ));
 sky130_fd_sc_hd__dfxtp_1 _5366_ (.CLK(clk),
    .D(_0286_),
    .Q(\cpu_inst.regfile_inst.registers[11][30] ));
 sky130_fd_sc_hd__dfxtp_1 _5367_ (.CLK(clk),
    .D(_0287_),
    .Q(\cpu_inst.regfile_inst.registers[11][31] ));
 sky130_fd_sc_hd__dfxtp_1 _5368_ (.CLK(clk),
    .D(_0288_),
    .Q(\cpu_inst.regfile_inst.registers[10][0] ));
 sky130_fd_sc_hd__dfxtp_1 _5369_ (.CLK(clk),
    .D(_0289_),
    .Q(\cpu_inst.regfile_inst.registers[10][1] ));
 sky130_fd_sc_hd__dfxtp_1 _5370_ (.CLK(clk),
    .D(_0290_),
    .Q(\cpu_inst.regfile_inst.registers[10][2] ));
 sky130_fd_sc_hd__dfxtp_1 _5371_ (.CLK(clk),
    .D(_0291_),
    .Q(\cpu_inst.regfile_inst.registers[10][3] ));
 sky130_fd_sc_hd__dfxtp_1 _5372_ (.CLK(clk),
    .D(_0292_),
    .Q(\cpu_inst.regfile_inst.registers[10][4] ));
 sky130_fd_sc_hd__dfxtp_1 _5373_ (.CLK(clk),
    .D(_0293_),
    .Q(\cpu_inst.regfile_inst.registers[10][5] ));
 sky130_fd_sc_hd__dfxtp_1 _5374_ (.CLK(clk),
    .D(_0294_),
    .Q(\cpu_inst.regfile_inst.registers[10][6] ));
 sky130_fd_sc_hd__dfxtp_1 _5375_ (.CLK(clk),
    .D(_0295_),
    .Q(\cpu_inst.regfile_inst.registers[10][7] ));
 sky130_fd_sc_hd__dfxtp_1 _5376_ (.CLK(clk),
    .D(_0296_),
    .Q(\cpu_inst.regfile_inst.registers[10][8] ));
 sky130_fd_sc_hd__dfxtp_1 _5377_ (.CLK(clk),
    .D(_0297_),
    .Q(\cpu_inst.regfile_inst.registers[10][9] ));
 sky130_fd_sc_hd__dfxtp_1 _5378_ (.CLK(clk),
    .D(_0298_),
    .Q(\cpu_inst.regfile_inst.registers[10][10] ));
 sky130_fd_sc_hd__dfxtp_1 _5379_ (.CLK(clk),
    .D(_0299_),
    .Q(\cpu_inst.regfile_inst.registers[10][11] ));
 sky130_fd_sc_hd__dfxtp_1 _5380_ (.CLK(clk),
    .D(_0300_),
    .Q(\cpu_inst.regfile_inst.registers[10][12] ));
 sky130_fd_sc_hd__dfxtp_1 _5381_ (.CLK(clk),
    .D(_0301_),
    .Q(\cpu_inst.regfile_inst.registers[10][13] ));
 sky130_fd_sc_hd__dfxtp_1 _5382_ (.CLK(clk),
    .D(_0302_),
    .Q(\cpu_inst.regfile_inst.registers[10][14] ));
 sky130_fd_sc_hd__dfxtp_1 _5383_ (.CLK(clk),
    .D(_0303_),
    .Q(\cpu_inst.regfile_inst.registers[10][15] ));
 sky130_fd_sc_hd__dfxtp_1 _5384_ (.CLK(clk),
    .D(_0304_),
    .Q(\cpu_inst.regfile_inst.registers[10][16] ));
 sky130_fd_sc_hd__dfxtp_1 _5385_ (.CLK(clk),
    .D(_0305_),
    .Q(\cpu_inst.regfile_inst.registers[10][17] ));
 sky130_fd_sc_hd__dfxtp_1 _5386_ (.CLK(clk),
    .D(_0306_),
    .Q(\cpu_inst.regfile_inst.registers[10][18] ));
 sky130_fd_sc_hd__dfxtp_1 _5387_ (.CLK(clk),
    .D(_0307_),
    .Q(\cpu_inst.regfile_inst.registers[10][19] ));
 sky130_fd_sc_hd__dfxtp_1 _5388_ (.CLK(clk),
    .D(_0308_),
    .Q(\cpu_inst.regfile_inst.registers[10][20] ));
 sky130_fd_sc_hd__dfxtp_1 _5389_ (.CLK(clk),
    .D(_0309_),
    .Q(\cpu_inst.regfile_inst.registers[10][21] ));
 sky130_fd_sc_hd__dfxtp_1 _5390_ (.CLK(clk),
    .D(_0310_),
    .Q(\cpu_inst.regfile_inst.registers[10][22] ));
 sky130_fd_sc_hd__dfxtp_1 _5391_ (.CLK(clk),
    .D(_0311_),
    .Q(\cpu_inst.regfile_inst.registers[10][23] ));
 sky130_fd_sc_hd__dfxtp_1 _5392_ (.CLK(clk),
    .D(_0312_),
    .Q(\cpu_inst.regfile_inst.registers[10][24] ));
 sky130_fd_sc_hd__dfxtp_1 _5393_ (.CLK(clk),
    .D(_0313_),
    .Q(\cpu_inst.regfile_inst.registers[10][25] ));
 sky130_fd_sc_hd__dfxtp_1 _5394_ (.CLK(clk),
    .D(_0314_),
    .Q(\cpu_inst.regfile_inst.registers[10][26] ));
 sky130_fd_sc_hd__dfxtp_1 _5395_ (.CLK(clk),
    .D(_0315_),
    .Q(\cpu_inst.regfile_inst.registers[10][27] ));
 sky130_fd_sc_hd__dfxtp_1 _5396_ (.CLK(clk),
    .D(_0316_),
    .Q(\cpu_inst.regfile_inst.registers[10][28] ));
 sky130_fd_sc_hd__dfxtp_1 _5397_ (.CLK(clk),
    .D(_0317_),
    .Q(\cpu_inst.regfile_inst.registers[10][29] ));
 sky130_fd_sc_hd__dfxtp_1 _5398_ (.CLK(clk),
    .D(_0318_),
    .Q(\cpu_inst.regfile_inst.registers[10][30] ));
 sky130_fd_sc_hd__dfxtp_1 _5399_ (.CLK(clk),
    .D(_0319_),
    .Q(\cpu_inst.regfile_inst.registers[10][31] ));
 sky130_fd_sc_hd__dfxtp_1 _5400_ (.CLK(clk),
    .D(_0320_),
    .Q(\cpu_inst.display_inst.digit_select[0] ));
 sky130_fd_sc_hd__dfxtp_1 _5401_ (.CLK(clk),
    .D(_0321_),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5403_ (.CLK(clk),
    .D(_0323_),
    .RESET_B(net2),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5408_ (.CLK(clk),
    .D(_0328_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[8] ));
 sky130_fd_sc_hd__dfrtp_1 _5409_ (.CLK(clk),
    .D(_0329_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[9] ));
 sky130_fd_sc_hd__dfrtp_1 _5410_ (.CLK(clk),
    .D(_0330_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[10] ));
 sky130_fd_sc_hd__dfrtp_1 _5411_ (.CLK(clk),
    .D(_0331_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[11] ));
 sky130_fd_sc_hd__dfrtp_1 _5412_ (.CLK(clk),
    .D(_0332_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[12] ));
 sky130_fd_sc_hd__dfrtp_1 _5413_ (.CLK(clk),
    .D(_0333_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[13] ));
 sky130_fd_sc_hd__dfrtp_1 _5414_ (.CLK(clk),
    .D(_0334_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[14] ));
 sky130_fd_sc_hd__dfrtp_1 _5415_ (.CLK(clk),
    .D(_0335_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[15] ));
 sky130_fd_sc_hd__dfrtp_1 _5416_ (.CLK(clk),
    .D(_0336_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[16] ));
 sky130_fd_sc_hd__dfrtp_1 _5417_ (.CLK(clk),
    .D(_0337_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[17] ));
 sky130_fd_sc_hd__dfrtp_1 _5418_ (.CLK(clk),
    .D(_0338_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[18] ));
 sky130_fd_sc_hd__dfrtp_1 _5419_ (.CLK(clk),
    .D(_0339_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[19] ));
 sky130_fd_sc_hd__dfrtp_1 _5420_ (.CLK(clk),
    .D(_0340_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[20] ));
 sky130_fd_sc_hd__dfrtp_1 _5421_ (.CLK(clk),
    .D(_0341_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[21] ));
 sky130_fd_sc_hd__dfrtp_1 _5422_ (.CLK(clk),
    .D(_0342_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[22] ));
 sky130_fd_sc_hd__dfrtp_1 _5423_ (.CLK(clk),
    .D(_0343_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[23] ));
 sky130_fd_sc_hd__dfrtp_1 _5424_ (.CLK(clk),
    .D(_0344_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[24] ));
 sky130_fd_sc_hd__dfrtp_1 _5425_ (.CLK(clk),
    .D(_0345_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[25] ));
 sky130_fd_sc_hd__dfrtp_1 _5426_ (.CLK(clk),
    .D(_0346_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[26] ));
 sky130_fd_sc_hd__dfrtp_1 _5427_ (.CLK(clk),
    .D(_0347_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[27] ));
 sky130_fd_sc_hd__dfrtp_1 _5428_ (.CLK(clk),
    .D(_0348_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[28] ));
 sky130_fd_sc_hd__dfrtp_1 _5429_ (.CLK(clk),
    .D(_0349_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[29] ));
 sky130_fd_sc_hd__dfrtp_1 _5430_ (.CLK(clk),
    .D(_0350_),
    .RESET_B(net2),
    .Q(\cpu_inst.decoder_inst.current_pc[30] ));
 sky130_fd_sc_hd__dfrtp_1 _5431_ (.CLK(clk),
    .D(_0351_),
    .RESET_B(net2),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5433_ (.CLK(clk),
    .D(_0353_),
    .Q(\cpu_inst.regfile_inst.registers[0][0] ));
 sky130_fd_sc_hd__dfxtp_1 _5434_ (.CLK(clk),
    .D(_0354_),
    .Q(\cpu_inst.regfile_inst.registers[0][1] ));
 sky130_fd_sc_hd__dfxtp_1 _5435_ (.CLK(clk),
    .D(_0355_),
    .Q(\cpu_inst.regfile_inst.registers[0][2] ));
 sky130_fd_sc_hd__dfxtp_1 _5436_ (.CLK(clk),
    .D(_0356_),
    .Q(\cpu_inst.regfile_inst.registers[0][3] ));
 sky130_fd_sc_hd__dfxtp_1 _5437_ (.CLK(clk),
    .D(_0357_),
    .Q(\cpu_inst.regfile_inst.registers[0][4] ));
 sky130_fd_sc_hd__dfxtp_1 _5438_ (.CLK(clk),
    .D(_0358_),
    .Q(\cpu_inst.regfile_inst.registers[0][6] ));
 sky130_fd_sc_hd__dfxtp_1 _5439_ (.CLK(clk),
    .D(_0359_),
    .Q(\cpu_inst.regfile_inst.registers[0][7] ));
 sky130_fd_sc_hd__dfxtp_1 _5440_ (.CLK(clk),
    .D(_0360_),
    .Q(\cpu_inst.regfile_inst.registers[0][8] ));
 sky130_fd_sc_hd__dfxtp_1 _5441_ (.CLK(clk),
    .D(_0361_),
    .Q(\cpu_inst.regfile_inst.registers[0][9] ));
 sky130_fd_sc_hd__dfxtp_1 _5442_ (.CLK(clk),
    .D(_0362_),
    .Q(\cpu_inst.regfile_inst.registers[0][10] ));
 sky130_fd_sc_hd__dfxtp_1 _5443_ (.CLK(clk),
    .D(_0363_),
    .Q(\cpu_inst.regfile_inst.registers[0][11] ));
 sky130_fd_sc_hd__dfxtp_1 _5444_ (.CLK(clk),
    .D(_0364_),
    .Q(\cpu_inst.regfile_inst.registers[0][12] ));
 sky130_fd_sc_hd__dfxtp_1 _5445_ (.CLK(clk),
    .D(_0365_),
    .Q(\cpu_inst.regfile_inst.registers[0][13] ));
 sky130_fd_sc_hd__dfxtp_1 _5446_ (.CLK(clk),
    .D(_0366_),
    .Q(\cpu_inst.regfile_inst.registers[0][14] ));
 sky130_fd_sc_hd__dfxtp_1 _5447_ (.CLK(clk),
    .D(_0367_),
    .Q(\cpu_inst.regfile_inst.registers[0][15] ));
 sky130_fd_sc_hd__dfxtp_1 _5448_ (.CLK(clk),
    .D(_0368_),
    .Q(\cpu_inst.regfile_inst.registers[0][16] ));
 sky130_fd_sc_hd__dfxtp_1 _5449_ (.CLK(clk),
    .D(_0369_),
    .Q(\cpu_inst.regfile_inst.registers[0][17] ));
 sky130_fd_sc_hd__dfxtp_1 _5450_ (.CLK(clk),
    .D(_0370_),
    .Q(\cpu_inst.regfile_inst.registers[0][18] ));
 sky130_fd_sc_hd__dfxtp_1 _5451_ (.CLK(clk),
    .D(_0371_),
    .Q(\cpu_inst.regfile_inst.registers[0][19] ));
 sky130_fd_sc_hd__dfxtp_1 _5452_ (.CLK(clk),
    .D(_0372_),
    .Q(\cpu_inst.regfile_inst.registers[0][20] ));
 sky130_fd_sc_hd__dfxtp_1 _5453_ (.CLK(clk),
    .D(_0373_),
    .Q(\cpu_inst.regfile_inst.registers[0][21] ));
 sky130_fd_sc_hd__dfxtp_1 _5454_ (.CLK(clk),
    .D(_0374_),
    .Q(\cpu_inst.regfile_inst.registers[0][22] ));
 sky130_fd_sc_hd__dfxtp_1 _5455_ (.CLK(clk),
    .D(_0375_),
    .Q(\cpu_inst.regfile_inst.registers[0][23] ));
 sky130_fd_sc_hd__dfxtp_1 _5456_ (.CLK(clk),
    .D(_0376_),
    .Q(\cpu_inst.regfile_inst.registers[0][24] ));
 sky130_fd_sc_hd__dfxtp_1 _5457_ (.CLK(clk),
    .D(_0377_),
    .Q(\cpu_inst.regfile_inst.registers[0][25] ));
 sky130_fd_sc_hd__dfxtp_1 _5458_ (.CLK(clk),
    .D(_0378_),
    .Q(\cpu_inst.regfile_inst.registers[0][26] ));
 sky130_fd_sc_hd__dfxtp_1 _5459_ (.CLK(clk),
    .D(_0379_),
    .Q(\cpu_inst.regfile_inst.registers[0][27] ));
 sky130_fd_sc_hd__dfxtp_1 _5460_ (.CLK(clk),
    .D(_0380_),
    .Q(\cpu_inst.regfile_inst.registers[0][28] ));
 sky130_fd_sc_hd__dfxtp_1 _5461_ (.CLK(clk),
    .D(_0381_),
    .Q(\cpu_inst.regfile_inst.registers[0][29] ));
 sky130_fd_sc_hd__dfxtp_1 _5462_ (.CLK(clk),
    .D(_0382_),
    .Q(\cpu_inst.regfile_inst.registers[0][30] ));
 sky130_fd_sc_hd__dfxtp_1 _5463_ (.CLK(clk),
    .D(_0383_),
    .Q(\cpu_inst.regfile_inst.registers[0][31] ));
 sky130_fd_sc_hd__dfxtp_1 _5464_ (.CLK(clk),
    .D(_0384_),
    .Q(\cpu_inst.regfile_inst.registers[9][0] ));
 sky130_fd_sc_hd__dfxtp_1 _5465_ (.CLK(clk),
    .D(_0385_),
    .Q(\cpu_inst.regfile_inst.registers[9][1] ));
 sky130_fd_sc_hd__dfxtp_1 _5466_ (.CLK(clk),
    .D(_0386_),
    .Q(\cpu_inst.regfile_inst.registers[9][2] ));
 sky130_fd_sc_hd__dfxtp_1 _5467_ (.CLK(clk),
    .D(_0387_),
    .Q(\cpu_inst.regfile_inst.registers[9][3] ));
 sky130_fd_sc_hd__dfxtp_1 _5468_ (.CLK(clk),
    .D(_0388_),
    .Q(\cpu_inst.regfile_inst.registers[9][4] ));
 sky130_fd_sc_hd__dfxtp_1 _5469_ (.CLK(clk),
    .D(_0389_),
    .Q(\cpu_inst.regfile_inst.registers[9][5] ));
 sky130_fd_sc_hd__dfxtp_1 _5470_ (.CLK(clk),
    .D(_0390_),
    .Q(\cpu_inst.regfile_inst.registers[9][6] ));
 sky130_fd_sc_hd__dfxtp_1 _5471_ (.CLK(clk),
    .D(_0391_),
    .Q(\cpu_inst.regfile_inst.registers[9][7] ));
 sky130_fd_sc_hd__dfxtp_1 _5472_ (.CLK(clk),
    .D(_0392_),
    .Q(\cpu_inst.regfile_inst.registers[9][8] ));
 sky130_fd_sc_hd__dfxtp_1 _5473_ (.CLK(clk),
    .D(_0393_),
    .Q(\cpu_inst.regfile_inst.registers[9][9] ));
 sky130_fd_sc_hd__dfxtp_1 _5474_ (.CLK(clk),
    .D(_0394_),
    .Q(\cpu_inst.regfile_inst.registers[9][10] ));
 sky130_fd_sc_hd__dfxtp_1 _5475_ (.CLK(clk),
    .D(_0395_),
    .Q(\cpu_inst.regfile_inst.registers[9][11] ));
 sky130_fd_sc_hd__dfxtp_1 _5476_ (.CLK(clk),
    .D(_0396_),
    .Q(\cpu_inst.regfile_inst.registers[9][12] ));
 sky130_fd_sc_hd__dfxtp_1 _5477_ (.CLK(clk),
    .D(_0397_),
    .Q(\cpu_inst.regfile_inst.registers[9][13] ));
 sky130_fd_sc_hd__dfxtp_1 _5478_ (.CLK(clk),
    .D(_0398_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5487_ (.CLK(clk),
    .D(_0407_),
    .Q(\cpu_inst.regfile_inst.registers[9][23] ));
 sky130_fd_sc_hd__dfxtp_1 _5488_ (.CLK(clk),
    .D(_0408_),
    .Q(\cpu_inst.regfile_inst.registers[9][24] ));
 sky130_fd_sc_hd__dfxtp_1 _5489_ (.CLK(clk),
    .D(_0409_),
    .Q(\cpu_inst.regfile_inst.registers[9][25] ));
 sky130_fd_sc_hd__dfxtp_1 _5490_ (.CLK(clk),
    .D(_0410_),
    .Q(\cpu_inst.regfile_inst.registers[9][26] ));
 sky130_fd_sc_hd__dfxtp_1 _5491_ (.CLK(clk),
    .D(_0411_),
    .Q(\cpu_inst.regfile_inst.registers[9][27] ));
 sky130_fd_sc_hd__dfxtp_1 _5492_ (.CLK(clk),
    .D(_0412_),
    .Q(\cpu_inst.regfile_inst.registers[9][28] ));
 sky130_fd_sc_hd__dfxtp_1 _5493_ (.CLK(clk),
    .D(_0413_),
    .Q(\cpu_inst.regfile_inst.registers[9][29] ));
 sky130_fd_sc_hd__dfxtp_1 _5494_ (.CLK(clk),
    .D(_0414_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5503_ (.CLK(clk),
    .D(_0423_),
    .Q(\cpu_inst.regfile_inst.registers[8][7] ));
 sky130_fd_sc_hd__dfxtp_1 _5504_ (.CLK(clk),
    .D(_0424_),
    .Q(\cpu_inst.regfile_inst.registers[8][8] ));
 sky130_fd_sc_hd__dfxtp_1 _5505_ (.CLK(clk),
    .D(_0425_),
    .Q(\cpu_inst.regfile_inst.registers[8][9] ));
 sky130_fd_sc_hd__dfxtp_1 _5506_ (.CLK(clk),
    .D(_0426_),
    .Q(\cpu_inst.regfile_inst.registers[8][10] ));
 sky130_fd_sc_hd__dfxtp_1 _5507_ (.CLK(clk),
    .D(_0427_),
    .Q(\cpu_inst.regfile_inst.registers[8][11] ));
 sky130_fd_sc_hd__dfxtp_1 _5508_ (.CLK(clk),
    .D(_0428_),
    .Q(\cpu_inst.regfile_inst.registers[8][12] ));
 sky130_fd_sc_hd__dfxtp_1 _5509_ (.CLK(clk),
    .D(_0429_),
    .Q(\cpu_inst.regfile_inst.registers[8][13] ));
 sky130_fd_sc_hd__dfxtp_1 _5510_ (.CLK(clk),
    .D(_0430_),
    .Q(\cpu_inst.regfile_inst.registers[8][14] ));
 sky130_fd_sc_hd__dfxtp_1 _5511_ (.CLK(clk),
    .D(_0431_),
    .Q(\cpu_inst.regfile_inst.registers[8][15] ));
 sky130_fd_sc_hd__dfxtp_1 _5512_ (.CLK(clk),
    .D(_0432_),
    .Q(\cpu_inst.regfile_inst.registers[8][16] ));
 sky130_fd_sc_hd__dfxtp_1 _5513_ (.CLK(clk),
    .D(_0433_),
    .Q(\cpu_inst.regfile_inst.registers[8][17] ));
 sky130_fd_sc_hd__dfxtp_1 _5514_ (.CLK(clk),
    .D(_0434_),
    .Q(\cpu_inst.regfile_inst.registers[8][18] ));
 sky130_fd_sc_hd__dfxtp_1 _5515_ (.CLK(clk),
    .D(_0435_),
    .Q(\cpu_inst.regfile_inst.registers[8][19] ));
 sky130_fd_sc_hd__dfxtp_1 _5516_ (.CLK(clk),
    .D(_0436_),
    .Q(\cpu_inst.regfile_inst.registers[8][20] ));
 sky130_fd_sc_hd__dfxtp_1 _5517_ (.CLK(clk),
    .D(_0437_),
    .Q(\cpu_inst.regfile_inst.registers[8][21] ));
 sky130_fd_sc_hd__dfxtp_1 _5518_ (.CLK(clk),
    .D(_0438_),
    .Q(\cpu_inst.regfile_inst.registers[8][22] ));
 sky130_fd_sc_hd__dfxtp_1 _5519_ (.CLK(clk),
    .D(_0439_),
    .Q(\cpu_inst.regfile_inst.registers[8][23] ));
 sky130_fd_sc_hd__dfxtp_1 _5520_ (.CLK(clk),
    .D(_0440_),
    .Q(\cpu_inst.regfile_inst.registers[8][24] ));
 sky130_fd_sc_hd__dfxtp_1 _5521_ (.CLK(clk),
    .D(_0441_),
    .Q(\cpu_inst.regfile_inst.registers[8][25] ));
 sky130_fd_sc_hd__dfxtp_1 _5522_ (.CLK(clk),
    .D(_0442_),
    .Q(\cpu_inst.regfile_inst.registers[8][26] ));
 sky130_fd_sc_hd__dfxtp_1 _5523_ (.CLK(clk),
    .D(_0443_),
    .Q(\cpu_inst.regfile_inst.registers[8][27] ));
 sky130_fd_sc_hd__dfxtp_1 _5524_ (.CLK(clk),
    .D(_0444_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5565_ (.CLK(clk),
    .D(_0485_),
    .Q(\cpu_inst.display_inst.counter[5] ));
 sky130_fd_sc_hd__dfxtp_1 _5566_ (.CLK(clk),
    .D(_0486_),
    .Q(\cpu_inst.display_inst.counter[6] ));
 sky130_fd_sc_hd__dfxtp_1 _5567_ (.CLK(clk),
    .D(_0487_),
    .Q(\cpu_inst.display_inst.counter[7] ));
 sky130_fd_sc_hd__dfxtp_1 _5568_ (.CLK(clk),
    .D(_0488_),
    .Q(\cpu_inst.display_inst.counter[8] ));
 sky130_fd_sc_hd__dfxtp_1 _5569_ (.CLK(clk),
    .D(_0489_),
    .Q(\cpu_inst.display_inst.counter[9] ));
 sky130_fd_sc_hd__dfxtp_1 _5570_ (.CLK(clk),
    .D(_0490_),
    .Q(\cpu_inst.display_inst.counter[10] ));
 sky130_fd_sc_hd__dfxtp_1 _5571_ (.CLK(clk),
    .D(_0491_),
    .Q(\cpu_inst.display_inst.counter[11] ));
 sky130_fd_sc_hd__dfxtp_1 _5572_ (.CLK(clk),
    .D(_0492_),
    .Q(\cpu_inst.display_inst.counter[12] ));
 sky130_fd_sc_hd__dfxtp_1 _5573_ (.CLK(clk),
    .D(_0493_),
    .Q(\cpu_inst.display_inst.counter[13] ));
 sky130_fd_sc_hd__dfxtp_1 _5574_ (.CLK(clk),
    .D(_0494_),
    .Q(\cpu_inst.display_inst.counter[14] ));
 sky130_fd_sc_hd__dfxtp_1 _5575_ (.CLK(clk),
    .D(_0495_),
    .Q(\cpu_inst.display_inst.counter[15] ));
 sky130_fd_sc_hd__dfxtp_1 _5576_ (.CLK(clk),
    .D(_0496_),
    .Q(\cpu_inst.display_inst.counter[16] ));
 sky130_fd_sc_hd__dfxtp_1 _5577_ (.CLK(clk),
    .D(_0497_),
    .Q(\cpu_inst.display_inst.counter[17] ));
 sky130_fd_sc_hd__dfxtp_1 _5578_ (.CLK(clk),
    .D(_0498_),
    .Q(\cpu_inst.display_inst.counter[18] ));
 sky130_fd_sc_hd__dfxtp_1 _5579_ (.CLK(clk),
    .D(_0499_),
