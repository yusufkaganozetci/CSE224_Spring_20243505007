module SemiCPU (clk,
 ...
 sky130_fd_sc_hd__o21a_4 _1062_ (.A1(_0271_),
    ...
    .B1(_0266_),
    .X(_0273_));
 sky130_fd_sc_hd__xnor2_4 _1063_ (.A(_0273_),
    .B(_0270_),
    .Y(_0274_));
 ...
 sky130_fd_sc_hd__xor2_4 _1086_ (.A(net39),
    .B(_0209_),
    .X(_0297_));
 sky130_fd_sc_hd__or2_4 _1087_ (.A(_0297_),
    .B(_0296_),
    .X(_0298_));
 ...
 sky130_fd_sc_hd__or2_4 _1091_ (.A(_0270_),
    .B(_0273_),
    .X(_0302_));
 sky130_fd_sc_hd__o311a_4 _1092_ (.A1(_0300_),
    .A2(_0295_),
    .A3(_0274_),
    .B1(_0301_),
    .C1(_0302_),
 ...
 sky130_fd_sc_hd__nor2_2 _1106_ (.A(_0203_),
    .B(_0239_),
    .Y(_0317_));
 sky130_fd_sc_hd__a21o_4 _1107_ (.A1(_0316_),
    .A2(_0240_),
    .B1(_0317_),
    .X(_0318_));
 ...
 sky130_fd_sc_hd__nor2_4 _1116_ (.A(_0325_),
    .B(_0326_),
    .Y(_0327_));
 sky130_fd_sc_hd__a21o_4 _1117_ (.A1(_0327_),
    .A2(_0318_),
    .B1(_0325_),
    .X(_0328_));
 ...
 sky130_fd_sc_hd__or4_4 _1133_ (.A(net25),
    ...
    .D(_0218_),
    .X(_0344_));
 sky130_fd_sc_hd__a21boi_4 _1134_ (.A1(_0344_),
    .A2(net56),
    .B1_N(net21),
    .Y(_0345_));
 sky130_fd_sc_hd__nor2_8 _1135_ (.A(_0188_),
    .B(_0218_),
    .Y(_0346_));
 sky130_fd_sc_hd__a2111oi_4 _1136_ (.A1(net66),
    .A2(_0343_),
    .B1(net35),
    .C1(_0346_),
    .D1(_0283_),
 ...
 sky130_fd_sc_hd__or2_4 _1257_ (.A(_0449_),
    .B(net13),
    .X(_0467_));
 sky130_fd_sc_hd__a21oi_4 _1258_ (.A1(_0334_),
    .A2(_0328_),
    .B1(_0332_),
    .Y(_0468_));
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer10 (.A(net31),
    .X(net32));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer11 (.A(_0345_),
    .X(net33));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer12 (.A(net33),
    .X(net34));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer13 (.A(_0345_),
    .X(net35));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer14 (.A(net35),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer15 (.A(net65),
    .X(net37));
 sky130_fd_sc_hd__clkbuf_2 rebuffer16 (.A(net37),
    .X(net38));
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer28 (.A(_0177_),
    .X(net50));
 sky130_fd_sc_hd__buf_6 rebuffer29 (.A(_0211_),
    .X(net51));
